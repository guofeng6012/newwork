...
//    public ResponseInfo deleBatchIds(@RequestBody List<String> list) throws BussException {
//        if(list == null || list.size() == 0){
//            throw new BussException("请先选择单据");
//        }
//        int result  =  baseDao.deleteBatchIds(list);
...
//        RedisUtil.set("pass:alex:12345678",0,60*1);
        RedisUtil.set("pass:alex111:"+"110110110"+"_"+123,0,60*1);
    }
